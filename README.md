...
| `CM_ALLOWED_ROOTS`  | `/home/pi,/var/www/html` | Comma-separated dir-picker roots (jail)  |
...
```bash
cd /home/pi/projects/claude_manager
node server.js
...
```bash
sudo /home/pi/projects/claude_manager/deploy/install.sh
```
...
```bash
sudo AUTH_USER=nick AUTH_PASS='your-pw' /home/pi/projects/claude_manager/deploy/install.sh
```
...
sudo htpasswd -c /etc/apache2/claude-manager.htpasswd nick
